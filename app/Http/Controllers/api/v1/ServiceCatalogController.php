    ...
    private function baseRelationsQuery()
    {
        return Offer::query()
            ...
            ->with([
                ...
                // المولَّد يربط جدول service_provider_subscriptions بنفسه عبر
                // subquery باسم عمود offer_id في الطرفين، فيصبح غامضاً فقط عندما
                // يُحدَّد SELECT صريح. سبّب هذا اختفاء كل خدمات الكتالوج العام
                // (500 على /services بسبب استثناء SQL غير مُعالَج) — تم رصده
