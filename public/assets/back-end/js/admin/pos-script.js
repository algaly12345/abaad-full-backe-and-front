...
$(".search-bar-input").on("keyup", function () {
    ...
    if (name.length > 0) {
        ...
        $.get({
            url: $("#route-admin-products-search-business-chart").data("url"),
            dataType: "json",
            data: {
                name: name,
            },
...
function renderSelectProduct() {
    ...
    $(".cart-qty-field").focus(function () {
        $(this).closest(".business-chart-quantity-group").addClass("border-primary");
    });

    $(".cart-qty-field").blur(function () {
        $(this)
            .closest(".business-chart-quantity-group")
        ...
        $.post({
            ...
            success: function (data) {
                if (data.data == 1) {
                    ...
                    $('.business-chart-stock-message').empty().html($('#get-business-chart-stock-message').data('out-of-stock'))
