'use strict';
$('.user-registration-reason-update-view').on('click',function (){
    $.ajax({
        ...
        success: function(response) {
            ...
            $('.user-registration-reason-update-modal').html(response.view);
            $('#update-user-registration-reason-modal').modal('show');
        },
        complete: function () {
            $('#loading').fadeOut();
        }
