...
function orderStatisticsApexChart() {
    ...
    const vendorOrderEarn = orderStatisticsData.data("user-order-earn");
    ...
    var options = {
        series: [
            ...
            {
                name: orderStatisticsData.data("user-text"),
...
function UserOverViewChart() {
    ...
    var options = {
        ...
        labels: [
            ...
            userOverViewData.data("user-title"),
...
function earningStatisticsApexChart() {
    ...
    const vendorEarn = earnStatisticsData.data("user-earn");
    ...
    var options = {
        series: [
            ...
            {
                name: earnStatisticsData.data("user-text"),
