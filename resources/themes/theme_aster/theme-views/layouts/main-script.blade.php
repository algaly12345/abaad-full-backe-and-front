...
<script src="{{ asset('assets/plugins/sweet_alert/sweetalert2.js') }}"></script>
<script src="{{ asset('assets/plugins/magnific-popup-1.1.0/jquery.magnific-popup.js') }}"></script>
<script src="{{asset('assets/plugins/easyzoom/easyzoom.min.js') }}"></script>
<script src="{{ asset('assets/js/toastr.js') }}"></script>
<script src="{{asset('assets/js/main.js') }}"></script>
<script src="{{ asset('assets/plugins/intl-tel-input/js/intlTelInput.js') }}"></script>
<script src="{{ asset('assets/js/country-picker-init.js') }}"></script>
