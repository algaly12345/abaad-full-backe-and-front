<audio id="myAudio">
    <source src="{{ asset('public/assets/front-end/sound/notification.mp3') }}" type="audio/mpeg">
</audio>

<div class="alert--container active">
    @if(env('APP_MODE') == 'demo')
        <div class="alert alert--message-2 alert-dismissible fade show" id="demo-reset-warning">
            <img width="28" class="align-self-start" src="{{ asset('public/assets/front-end/img/info-2.png') }}" alt="">
            <div class="w--0">
