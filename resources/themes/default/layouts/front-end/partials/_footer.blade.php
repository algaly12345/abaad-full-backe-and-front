                ...
                <div class="footer-slider owl-theme owl-carousel">
                        ...
                        <div>
                            <a href="{{route('about-us')}}">
                                <div class="text-center">
                                    <img class="object-contain" width="36" height="36" src="{{ asset('public/assets/front-end/png/about-company.png')}}"
                                        alt="">
                                </div>
                                <div class="text-center">
                                    <p class="m-0">
                                    ...
                                    <small class="d-none d-sm-block">{{translate('Know about our abaad more')}}</small>
                                </div>
                            </a>
                        </div>
                    </div>
                    <div class="footer-slide-item">
                        <div>
                            <a href="{{route('contacts')}}">
                                <div class="text-center">
                                    <img class="object-contain" width="36" height="36" src="{{ asset('public/assets/front-end/png/contact-us.png')}}"
                                        alt="">
                                </div>
                                <div class="text-center">
                                    <p class="m-0">
                                    ...
                                    <small class="d-none d-sm-block">{{translate('We are Here to Help')}}</small>
                                </div>
                            </a>
                        </div>
                    </div>
                    <div class="footer-slide-item">
                        <div>
                            <a href="{{route('terms')}}">
                                <div class="text-center">
                                    <img class="object-contain" width="36" height="36" src="{{ asset('public/assets/front-end/png/faq.png')}}"
                                        alt="">
                                </div>
                                <div class="text-center">
                                    <p class="m-0">
                                        {{ __('messages.Terms and Conditions')}}
                                    </p>
                                    <small class="d-none d-sm-block">{{translate('Terms and Conditions')}}</small>
                                </div>
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-3 col-6 footer-padding-bottom text-start">
                                ...
                                <ul class="widget-list __pb-10px">
                                    ...
                                    <li class="widget-list-item">
                                        <a class="widget-list-link"
                                           href="{{route('home',['data_from'=>'featured','page'=>1])}}">
                                            {{ translate('service providers')}}
                                        </a>
                                    </li>
                                    <li class="widget-list-item">
                                        <a class="widget-list-link"
                                           href="{{route('home',['data_from'=>'latest','page'=>1])}}">
                                            {{ translate('zones')}}
                                        </a>
                                    </li>
                                    <li class="widget-list-item">
                                        <a class="widget-list-link"
                                           href="{{route('home',['data_from'=>'best-selling','page'=>1])}}">
                                            {{ translate('real estate with offers')}}
                                        </a>
                                    </li>
                                    {{-- <li class="widget-list-item">
                                        <a class="widget-list-link"
                                           href="{{route('home',['data_from'=>'top-rated','page'=>1])}}">
                                            {{ __('messages.top_rated_product')}}
                                        </a>
                                    </li> --}}
                            ...
                            <div class="col-sm-4 col-6 footer-padding-bottom text-start">
                                <h6 class="text-uppercase mobile-fs-12 font-semi-bold footer-header">{{ __('messages.account_&_shipping_info')}}</h6>
                                ...
                                @else
                                    <ul class="widget-list __pb-10px">
                                        <li class="widget-list-item">
                                            <a class="widget-list-link"
                                               href="{{route('customer.auth.login')}}">{{ translate('profile info')}}</a>
                                        </li>
                                        <li class="widget-list-item">
                                            <a class="widget-list-link"
                                               href="{{route('customer.auth.login')}}">{{ translate('wish list')}}</a>
                                        </li>

                                        <li class="widget-list-item">
                                            <a class="widget-list-link"
                                               href="{{route('home')}}">{{ translate('my properties')}}</a>
                                        </li>

                                        @if(isset($refund_policy['status']) && $refund_policy['status'] == 1)
                                            <li class="widget-list-item">
                                                <a class="widget-list-link"
                                                   href="{{route('refund-policy')}}">{{ __('refund policy')}}</a>
                                            </li>
                                        @endif
                                        ...
                                        @if(isset($return_policy['status']) && $return_policy['status'] == 1)
                                            <li class="widget-list-item">
                                                <a class="widget-list-link"
                                                   href="{{route('return-policy')}}">{{ translate('return policy')}}</a>
                                            </li>
                                        @endif
                                ...
                                <div class="row text-start">
                                    <div class="col-12 start_address ">
                                        ...
                                        <div class="pe-3">
                                            @if(auth('customer')->check())
                                                <a 
                                                class="widget-list-link    <a href="javascript:void(0);" 
   data-toggle="modal" 
                            ...
                            <div class="col-md-5 text-start">
                                <div
                                    ...
                                    <div class="d-none d-md-block">
                                        <span class="mb-4 font-weight-bold footer-header">{{ __('messages.address')}}</span>
                                    </div>
                                    <div
                                ...
                                <div>
                                    <span
                                        ...
                                        <span>{{ getWebConfig(name: 'address')}}</span>
                                    </span>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="d-flex flex-wrap end-footer footer-end last-footer-content-align text-center pt-3 pb-4 py-md-0">
                    ...
                    <div class="d-flex __text-14px justify-content-center">
                        <div class="me-3">
                            <a class="widget-list-link"
                               href="{{route('terms')}}">{{ __('messages.terms_&_conditions')}}</a>
                        </div>
                        <div>
