                            ...
                            <form class="mt-3 px-sm-2 pb-2" action="{{route('user-update')}}" method="post"
                                ...
                                <div class="row g-3">
                                    <div class="form-group col-md-6 mb-0">
                                        <label for="firstName"
                                               class="mb-2 text-capitalize">{{translate('full_name')}} </label>
                                    ...
                                    <div class="form-group col-md-6 mb-0">
                                        <label for="lastName"
                                               class="mb-2 text-capitalize"> {{translate('phone')}} </label>
                                        <input type="text" class="form-control" id="phone" name="phone"
                                               value="{{$customerDetail['phone']}}" disabled>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 mb-0">
                                        <label for="snapchat"
                                               class="mb-2 text-capitalize">{{translate('snapchat')}} </label>
                                        <input type="text" class="form-control" id="snapchat" name="snapchat"
                                               value="{{$customerDetail['snapchat']}}" >
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 mb-0">
                                        <label for="instagram"
                                               class="mb-2 text-capitalize">{{translate('instagram')}} </label>
                                        <input type="text" class="form-control" id="instagram" name="instagram"
                                               value="{{$customerDetail['instagram']}}" >
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 mb-0">
                                        <label for="youtube"
                                               class="mb-2 text-capitalize">{{translate('youtube')}} </label>
                                        <input type="text" class="form-control" id="youtube" name="youtube"
                                               value="{{$customerDetail['youtube']}}" >
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 mb-0">
                                        <label for="tiktok"
                                               class="mb-2 text-capitalize">{{translate('tiktok')}} </label>
                                        <input type="text" class="form-control" id="tiktok" name="tiktok"
                                               value="{{$customerDetail['tiktok']}}" >
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 mb-0">
                                        <label for="twitter"
                                               class="mb-2 text-capitalize">{{translate('twitter')}} </label>
                                        <input type="text" class="form-control" id="twitter" name="twitter"
                                               value="{{$customerDetail['twitter']}}" >
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 mb-0">
                                        <label for="website"
                                               class="mb-2 text-capitalize">{{translate('website')}} </label>
