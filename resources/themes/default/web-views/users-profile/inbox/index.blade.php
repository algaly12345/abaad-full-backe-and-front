...
@push('script')
    <script src="{{ asset('public/assets/front-end/js/chatting.js')}}"></script>
    <script src="{{ asset('public/assets/front-end/js/picmo-emoji.js')}}"></script>
    <script src="{{ asset('public/assets/front-end/js/emoji.js')}}"></script>
    <script src="{{ asset('public/assets/front-end/js/select-multiple-file.js')}}"></script>
    <script src="{{ asset('public/assets/front-end/js/select-multiple-image-for-message.js')}}"></script>
@endpush
