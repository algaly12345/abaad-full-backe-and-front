<div class="vertical-menu">
    ...
    <div class="h-100">
        ...
        <div class="user-wid text-center py-4">
            <div class="user-img">
               <img src="{{ auth()->guard('user')->user()?->provider?->image
     ...
     class="avatar-md mx-auto rounded-circle">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="{{ route('service-provider.offers.pending') }}" class=" waves-effect">
                ...
                <li>
                    <a href="{{ route('service-provider.owner.offers.pending') }}" class=" waves-effect">
                        <i class="mdi mdi-calendar-text"></i>
                        <span>عروضي</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('service-provider.estaes.create-offer') }}" class=" waves-effect">
                        <i class="mdi mdi-calendar-text"></i>
                        <span>إضافة عرض</span>
                    </a>
                </li>
