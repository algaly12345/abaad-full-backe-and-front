...
<div class="card">
    <div class="card-body">
        ...
        <form action="{{ route('service-providers.update',$user->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="mb-3">
                        <label class="form-label">أسم مزود الخدمة</label>
                        @error('name')
                   ...
                   @enderror
                    ...
                    <div class="input-group">
                            ...
                            <input value="{{ $user->provider->address }}" type="text" name="address" class="form-control"/ >
                ...
                <div class="col-lg-6">
                   ...
                   @enderror
                        <div class="input-group">
                            ...
                            <input value="{{ $user->provider->identity_number }}" type="text" name="identity_number" class="form-control"/ >
                   ...
                   @enderror
                        <div class="input-group">
                            ...
                            <select name="identity_type" class="form-control" id="">
                                <option value="جواز سفر" {{ $user->provider->identity_type == 'جواز سفر' ? 'selected' : '' }}>
                                     جواز سفر
                                </option>
                                <option value="بطاقة هوية" {{ $user->provider->identity_type == 'بطاقة هوية' ? 'selected' : '' }} >
                                    بطاقة هوية
                                </option>
                            </select>
                   ...
                   @enderror
                        <div class="input-group">
                            ...
                            <input value="{{ $user->provider->job }}" type="text" name="job" class="form-control"/ >
                    ...
                    <div class="input-group">
                            ...
                            <select name="service_type" id="" class="form-control select-item">
                                @foreach ($serviceTypes as $serviceType)
                                    <option {{ $serviceType->id == $user->provider->service_type_id ? 'selected' : '' }} value="{{ $serviceType->id }}">{{ $serviceType->name }}</option>
                                @endforeach
                            </select>
...
<script>
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC698w-7CmAo27obPPuVwVcbtfyiO7Y61M&libraries=drawing,places&callback=initMap&v=3.45.8">
    </script>
    <script>
