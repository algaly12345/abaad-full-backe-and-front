                   ...
                   @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input value="{{ $admin->phone }}" type="tel" name="phone" class="form-control"/ >
                        ...
                        <label class="form-label">الادوار</label>
                         <div class="row">
                            ...
                            <div class="col-4 d-flex justify-between">
                                ...
                                <div>
                                    <input {{ in_array($role->id,$admin->roles->pluck('id')->toArray()) ? 'checked' : '' }} name="selectedRoles[]" value="{{ $role->id }}" type="checkbox" id="switch{{ $role->id }}" switch="none" />
