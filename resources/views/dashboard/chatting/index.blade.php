                                    ...
                                    <div class="position-relative d-flex">
                                        ...
                                        <div class="d-flex align-items-center justify-content-center bg-F1F7FF radius-right-button">
                                            <button class="aSend bg-transparent outline-0 border-0 shadow-0 px-0 h-100 send-btn" type="submit" id="msgSendBtn">
                                                <img src="{{asset( 'public/assets/back-end/img/send-icon.png')}}" alt="">
                                            </button>
                                        </div>
                    ...
                    @else
                        <div class="d-flex justify-content-center align-items-center h-100">
                            <div class="d-flex flex-column align-items-center gap-3">
                                <img src="{{ asset( 'public/assets/back-end/img/empty-message.png') }}" alt="">
...
@push('script')
    ...
    <script src="{{ asset( 'public/assets/back-end/js/picmo-emoji.js')}}"></script>
    <script src="{{ asset( 'public/assets/back-end/js/emoji.js')}}"></script>
    <script src="{{ asset( 'public/assets/back-end/js/select-multiple-file.js')}}"></script>
